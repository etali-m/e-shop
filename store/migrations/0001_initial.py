# Generated by Django 3.2.8 on 2021-10-28 05:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default='uncategorized', on_delete=django.db.models.deletion.CASCADE, to='store.category')),
                ('provider', models.ManyToManyField(to='store.Provider')),
            ],
        ),
        migrations.CreateModel(
